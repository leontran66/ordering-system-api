...
export const createProduct = 'INSERT INTO products (category_id, name, price) VALUES(${category}, ${name}, ${price})';
...
export const updateProduct = 'UPDATE products SET name = ${name}, price = ${price} WHERE id = ${id}';
